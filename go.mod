module github.com/lightninglabs/lnget
...
require (
	...
	github.com/lightninglabs/aperture v0.4.2
...
// Required for lnd v0.20.0-beta which uses custom protobuf with UseHexForBytes.
